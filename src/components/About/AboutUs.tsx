    ...
    >
      ...
      <p className="text-center">
        ...
        <span className="about-text-content text-gray-700 max-w-2xl block mx-auto text-xs md:text-sm lg:text-base ">
          ...
          انتاجيتك وهدا بتوفير مجموعة من المذكرات التي تتبع احدث النظريات وافضل
          الطرق لتحقيق نتائج فمهما كان هدفك تحصيل دراسي او الحصول على ترقية او
          اتباع حمية مذكرات ميم ستور ستساعدك حتما
        </span>
      </p>
    </div>
  );
